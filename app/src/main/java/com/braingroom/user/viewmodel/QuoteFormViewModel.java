...
public class QuoteFormViewModel extends ViewModel {
    ...
    public final DataItemViewModel unitValue;
    ...
    public final ListDialogViewModel1 classModeVm, durationVm;
    ...
    public QuoteFormViewModel(@NonNull final MessageHelper messageHelper, @NonNull final QuoteFormFragment.UiHelper uiHelper,
        ...
        unitValue = new DataItemViewModel("");
        ...
        final LinkedHashMap<String, Integer> durationTypeMap = new LinkedHashMap<>();
        durationTypeMap.put("Days", 1);
        durationTypeMap.put("Month", 2);
        ...
        onSubmit = new Action() {
            ...
            public void run() throws Exception {
                ...
                if (isEmpty(durationVm.getSelectedItemsId())) {
                    messageHelper.show("Please select Duration Type");

                }
                if (isEmpty(unitValue.s_1.get())) {
                    messageHelper.show("Please enter no. day/month");
                }
                ...
                snippet.setQuoteUnit("" + durationVm.selectedItemsMap.keySet().iterator().next());
                snippet.setQuoteUnitValue(unitValue.s_1.get());
