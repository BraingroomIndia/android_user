...
public class LocationFilterViewModel extends CustomDialogViewModel {
    ...
    public LocationFilterViewModel(@NonNull final MessageHelper messageHelper, @NonNull final Navigator navigator, @NonNull HelperFactory helperFactory, final ConnectHomeActivity.UiHelper uiHelper) {
        ...
        stateVm = new ListDialogViewModel1(helperFactory.createDialogHelper(), "State", messageHelper, getStateApiObservable("-1"), selectedStates, false, stateConsumer);
        cityVm = new ListDialogViewModel1(helperFactory.createDialogHelper(), "City", messageHelper, getCityApiObservable("-1"), selectedCity, false, null);
