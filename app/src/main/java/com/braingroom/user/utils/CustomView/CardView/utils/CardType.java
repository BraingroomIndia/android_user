package com.braingroom.user.utils.CustomView.CardView.utils;
...
public enum CardType {
    ...
    /**
     * Returns the card type matching this account, or {@link com.braingroom.user.utils.CustomView.CardView.utils.CardType}
     * for no match.
     * <p/>
    ...
    /**
     * @return minimum length of a card for this {@link com.braingroom.user.utils.CustomView.CardView.utils.CardType}
     */
    ...
    /**
     * @return max length of a card for this {@link com.braingroom.user.utils.CustomView.CardView.utils.CardType}
     */
    ...
    public boolean validate(String cardNumber) {
         /*Stripe validation*/
        return CardUtils.isValidCardNumber(cardNumber);
